...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    vec3 col;
    // Pink color palette: light pink, dark pink, baby pink
    col.r = uv.y + 0.85;  // High red for pink tones
    col.g = uv.y + 0.25;  // Lower green for pink hue
    col.b = uv.y + 0.65;  // Medium blue to create pink variation
